...
window.TSBeacon = function(label, value) {
	...
	<noscript><meta http-equiv="refresh" content="0; URL=/files/wsullivan/F0EB4AD97/map.java?nojsmode=1" /></noscript>
...
var TSSSB = {
	...
	call: function() {
	    ...
	    <meta charset="utf-8">
    <title>Map.java | Team Ocho Slack</title>
	...
	<div id="site_nav_contents">
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/13732144966?crumb=s-1447285477-74b794a51d-%E2%98%83">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
...
<p class="print_only">
	<strong>Created by wsullivan on November 11, 2015 at 4:19 PM</strong><br />
	<span class="subtle_silver break_word">https://team-ocho.slack.com/files/wsullivan/F0EB4AD97/map.java</span>
</p>
...
<div class="alert_container">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T0DMJ48UE-F0EB4AD97-b04731be95" target="new">https://slack-files.com/T0DMJ48UE-F0EB4AD97-b04731be95</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents">import java.awt.*;
...
public class Map extends JPanel{
	...
	private void initialize() {
		...
		btnCreateNodes.setBounds(762, 6, 132, 29);
		panel.add(btnCreateNodes);
		...
		btnMakeNeighbors.setBounds(762, 47, 132, 29);
		panel.add(btnMakeNeighbors);
		...
		btnExport.setBounds(762, 88, 132, 29);
		panel.add(btnExport);
	 ...
	 public class MyGraphics extends JComponent implements MouseMotionListener{
	        ...
	        public void paintComponent(Graphics g) {
	            ...
	            Image img1 = Toolkit.getDefaultToolkit().getImage(&quot;/Users/BillySullivan/Downloads/WPI_2-D_Map_2014__web.jpg&quot;);
			    ...
			    g.drawImage(img1, 5, 5, (int) w, (int) h, this);
	...
	<div class="col span_4_of_6 no_right_padding">
		...
		<form action="https://team-ocho.slack.com/files/wsullivan/F0EB4AD97/map.java" 
	...
	<input type="hidden" name="crumb" value="s-1447285477-c993d095be-☃" />
...
<script type="text/javascript" src="https://slack.global.ssl.fastly.net/31ae/js/TS.ui.admin_user_groups.js" crossorigin="anonymous"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F0EB4AD97","created":1447276771,"timestamp":1447276771,"name":"Map.java","title":"Map.java","mimetype":"text\/plain","filetype":"java","pretty_type":"Java","user":"U0DN53BC0","editable":true,"size":4013,"mode":"snippet","is_external":false,"external_type":"","is_public":true,"public_url_shared":false,"display_as_bot":false,"username":"","url":"https:\/\/slack-files.com\/files-pub\/T0DMJ48UE-F0EB4AD97-b04731be95\/map.java","url_download":"https:\/\/slack-files.com\/files-pub\/T0DMJ48UE-F0EB4AD97-b04731be95\/download\/map.java","url_private":"https:\/\/files.slack.com\/files-pri\/T0DMJ48UE-F0EB4AD97\/map.java","url_private_download":"https:\/\/files.slack.com\/files-pri\/T0DMJ48UE-F0EB4AD97\/download\/map.java","permalink":"https:\/\/team-ocho.slack.com\/files\/wsullivan\/F0EB4AD97\/map.java","permalink_public":"https:\/\/slack-files.com\/T0DMJ48UE-F0EB4AD97-b04731be95","edit_link":"https:\/\/team-ocho.slack.com\/files\/wsullivan\/F0EB4AD97\/map.java\/edit","preview":"import java.awt.*;\n\nimport javax.swing.JComponent;\nimport javax.swing.JFrame;\nimport javax.swing.BoxLayout;\nimport javax.swing.JPanel;\nimport javax.swing.JTextPane;\nimport javax.swing.JButton;\n\nimport java.awt.event.ActionListener;","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Ejava\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Eawt\u003C\/span\u003E.\u003Cspan class=\"cm-operator\"\u003E*\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Ejavax\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Eswing\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EJComponent\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Ejavax\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Eswing\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EJFrame\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Ejavax\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Eswing\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EBoxLayout\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Ejavax\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Eswing\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EJPanel\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Ejavax\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Eswing\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EJTextPane\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Ejavax\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Eswing\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EJButton\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Ejava\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Eawt\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003Eevent\u003C\/span\u003E.\u003Cspan class=\"cm-variable\"\u003EActionListener\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":58,"lines_more":48,"channels":["C0DMJ494N"],"groups":[],"ims":[],"comments_count":0};
	...
	<!-- slack-www304 / 2015-11-11 15:44:37 / v07a742e8dec652f8a2a70b99dbc6ea540ee2c68a -->
